          ...
          <div class="row">
            <div class="col s6">
              <select id="departamento" name="departamento" required="">                
                <?php  
                $sel_edo = $con->prepare("SELECT iddepartamentos FROM departamentos WHERE departamento = ? ");
                $sel_edo->bind_param('i',  $f_prop['departamento']);
                $sel_edo->execute();
                $res_edo = $sel_edo->get_result();
                if ($f_edo = $res_edo->fetch_assoc()){
                } ?>
                <option value="<?php echo $f_edo['iddepartamentos'] ?>" disabled selected>
                  <?php echo $f_prop['departamento'] ?>
                </option>
                ...
                <option value="<?php echo $f_departamento['iddepartamentos'] ?>"><?php echo $f_departamento['departamento'] ?>
                </option>
                <?php }
            ...
            <div class="col s6">
                <div class="res_departamento">
                <input type="text" name="provincia" value="<?php echo $f_prop['provincia'] ?>" readonly="">
                </div>
            </div>
          </div>
        <div class="row">
          <div class="col s6">
            ...
            <div class="input-field">
              ...
              <input type="text" name="longitud"  id="latitud" value="<?php echo $f_prop['longitud'] ?>" >
          ...
          <div class="col s6">
            ...
            <div class="input-field">
              <input type="text" name="latitud"  id="latitud" value="<?php echo $f_prop['latitud'] ?>" >
